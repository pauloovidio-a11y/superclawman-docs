...
window.INVENTORY = {
  generated_at: "2026-05-18T22:46:28-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.15",
  ...
  agents: [
    {
      ...
      stats: { skills: 29, scripts: 85, subagents: 3, hooks: 2, doctrine: 34 }
    },
    {
      id: "superclawman",
      name: "Superclawman",
      ...
      stats: { skills: 7, scripts: 96, subagents: 7, playbooks: 7, plugins: 9 }
    },
    {
      id: "ktulu",
      name: "Ktulu",
      ...
      stats: { doctrine: 8, plugins: 5, launchdaemons: 9, pipeline_modules: 10, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      stats: { shared_scripts: 20, mcps: 7, skills: 3, systemd_units: 14, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
