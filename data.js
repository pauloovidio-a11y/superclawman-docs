...
window.INVENTORY = {
  generated_at: "2026-05-28T21:30:00-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.29",
  ...
  agents: [
    ...
    },
    {
      ...
      stats: { doctrine: 8, plugins: 6, launchdaemons: 25, pipeline_modules: 16, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      stats: { shared_scripts: 29, mcps: 4, skills: 3, systemd_units: 35, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
