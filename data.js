...
window.INVENTORY = {
  generated_at: "2026-06-08T22:46:08-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.46",
  ...
  agents: [
    {
      ...
      stats: { skills: 29, scripts: 125, subagents: 3, hooks: 2, doctrine: 33 }
    },
    {
      id: "superclawman",
      name: "Superclawman",
      ...
      openclaw_version: "2026.6.1 (2e08f0f) — fleet-wide 6.1 upgrade 2026-06-08",
      status_phase: "launchagents 23→24: +ai.openclaw.superclawman.script-review-fleet-hub (script review fleet hub, 1200s interval, 2026-06-08) · OpenClaw 5.28→6.1 (2e08f0f) 2026-06-08 · Production · canonical authoring host · launchagents 22→23 (+ai.openclaw.mcp-health-probe 2026-06-03, MCP health probe 1200s) · plugins.allow 10→11: +sc-location-context (location context plugin, installed as extensions/sc-location-context/ 2026-06-04) · +bash-guard plugin 2026-06-01 (10 plugins total) · OpenClaw 5.22→5.28 (e932160) 2026-06-01",
      ...
      stats: { skills: 7, scripts: 157, subagents: 7, playbooks: 7, launchagents: 24, plugins: 11 }
    },
    {
      id: "ktulu",
      name: "Ktulu",
      ...
      stats: { doctrine: 9, plugins: 7, launchdaemons: 38, pipeline_modules: 17, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      openclaw_version: "2026.6.1 (2e08f0f) — fleet-wide 6.1 upgrade 2026-06-08",
      status_phase: "systemd_units 42→46: +openclaw-jr-distill-compaction.service+timer (Wave 4 DREAMING-ON-COMPACTION opportunistic memory consolidation, 2026-06-08) + openclaw-jr-adherence.service+timer (Wave 1 memory-ADHERENCE metric OFFLINE drafter scores hits/N, 2026-06-08) · shared_scripts 36→37: +jr-distill-compaction-trigger.py (distill compaction trigger, 2026-06-08) · OpenClaw 5.28→6.1 (2e08f0f) 2026-06-08 · JR MVP COMPLETE · canonical v1.45 (0d.4.4 self-firing 7-day soak review wired 2026-05-28; 0d.6 inter-agent comms + 0d.7.4 cross-primary backup monitoring + 0d.4 multimodal substrate 2026-05-27) · v1.32 lighter-SC ports · ON THE CENTRAL CC BOARD 2026-05-22/23 (full dashboard :8990 + Fleet card on SC :8991, 4/4 green) · Heimdall-less by design · systemd_units 42 (+openclaw-jr-walprune.service+timer 2026-06-01; +script-review-safety.service+timer prev; +learn-capture service+timer 2026-05-28; +jr-0d44-soak-review service+timer 2026-05-28; +8 on 2026-05-27) · shared_scripts 36 (+jr-ktulu-jobwatch.py 2026-06-02; +jr-wal-autoprune.py+jr-memory-watch.py 2026-06-01; +jr-sandman-jobwatch.py+jr-sc-jobwatch.py prev) · OpenClaw 5.22→5.28 (e932160) 2026-06-01 · Phase 0d.7.0 multi-primary substrate: 0d.7.4 backup-monitor live; rest pending · biometrics venv live (InsightFace faces + SpeechBrain voices, 1.7GB, 7-day soak from 2026-05-27, automatic verdict 2026-06-03 09:00 BRT via OnCalendar one-shot)",
      ...
      stats: { shared_scripts: 37, mcps: 4, skills: 3, systemd_units: 46, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
  ...
  sections: [
...

    {
      ...
      rows: [
        ...
        { name: "plugins.allow IS RESTRICTED", status: { sandman: "no", superclawman: "yes", ktulu: "yes", jr: "yes" },
          notes: { default: "Hardened allowlist — only explicitly-listed plugins load.", sandman: "Explicit 69-plugin list (effective unrestricted — all major providers; 68→69 +opencode-go 2026-06-02). Tightening is canonical TODO.", superclawman: "anthropic, browser, firecrawl, lossless-claw, perplexity, whatsapp, memory-core, openai, codex (2026-05-17 for codex script-review pipeline), bash-guard (+2026-06-01 — 10 total).", ktulu: "anthropic, whatsapp, memory-core, lossless-claw, browser, ktulu-sendguard — 6 plugins (browser added 2026-05-16; ktulu-sendguard 2026-05-25).", jr: "telegram, anthropic, lossless-claw, browser, perplexity, firecrawl + device-pair (6+1)." } }
      ]
    },
...

    {
      ...
      rows: [
        ...
        { name: "ai.openclaw.ktulu.{gateway,ingest,worker,sender,backup,digest,wa-watchdog,script-review-c2-watcher,script-review-safety,qmd-refresh,dashboard,health-ledger,wa-probe,bootstrap-budget,llm-cost-fetch,health-pulse,activity-collect,followup,inter-agent,jr-wa-status,learn-capture,patch-watchdog,weekly-report,contact-ingest,embed-server}", status: { sandman: "no", superclawman: "no", ktulu: "yes", jr: "no" },
          notes: { default: "Ktulu's 25 active LaunchDaemons.", sandman: "N/A.", superclawman: "N/A.", ktulu: "25 active LaunchDaemons (all KeepAlive, logs /var/log/ktulu/): core pipeline (gateway/ingest/worker/sender — v1.0) + backup (v1.1, daily GPG to QNAP) + digest (v1.2.a, 21:00 BRT status envelope, action-clarity rule) + qmd-refresh (22:00 BRT) + wa-watchdog (3-min WA disconnect recovery) + script-review-c2-watcher + script-review-safety (renamed from codex-review-* 2026-05-29) + dashboard (full CC :8990, 2026-05-22) + health-ledger (HC.io pings, StartInterval 300) + wa-probe + bootstrap-budget + llm-cost-fetch + health-pulse + activity-collect (2026-05-24, fleet-wide deploy) + followup (2026-05-28, 14:00 BRT cadence engine) + inter-agent (2026-05-27, bearer REST) + jr-wa-status (2026-05-25) + learn-capture (2026-05-25, nightly 02:30 BRT) + patch-watchdog (2026-05-29) + weekly-report (2026-05-25) + contact-ingest (NEW 2026-06-02: ktulu_contact_ingest.py, 3-min watch on events/inbound+outbound.jsonl, contact memory ingestion) + embed-server (NEW 2026-06-02: llama-server embeddinggemma-300M-Q8_0 on :8199, local vector embeddings). Plus 7 bak files.", jr: "N/A." } },
...

    {
      ...
      rows: [
        ...
        { name: "Notion Docs hub", status: { sandman: "yes", superclawman: "yes", ktulu: "yes", jr: "yes" },
          notes: { default: "**Single consolidated hub** for all 4 agents' canonical docs: 🧠⚡🦀🤘 Superclawman Docs at `355085df-9ff8-8122-b7fd-fa633a08a7b3` (per docs-system standard codified 2026-06-01).", sandman: "Sandman canonicals (Master Blueprint, Central Control Center, Heimdall, NAS Backup, legacy Canonical Architecture) MOVED to Superclawman Docs hub 2026-06-01. The old standalone `💀 Sandman Docs` hub at `355085df-9ff8-8199-88ca-c11602a40560` is tombstoned with a redirect callout.", superclawman: "Superclawman Docs hub at `355085df-9ff8-8122-b7fd-fa633a08a7b3` — now the SINGLE canonical location for all 4 agents' documentation. Children include the Master Blueprints (SC + Sandman), per-agent canonicals (Ktulu, Jr, WhatsApp, X, Memory, NAS Backup, Heimdall, CC), and cross-cutting refs (Reference Architecture, Watch System, Script Review pipeline, Self-Learning canonical).", ktulu: "Ktulu canonical lives under Superclawman Docs hub: 'Ktulu — Canonical Build Reference v2.0' at `361085df-9ff8-8188-be25-d45891c6aa5f`.", jr: "Jr canonical lives under Superclawman Docs hub: 'Superclawman Watchdog v2 / Jr — Canonical Architecture v1.49' at `364085df-9ff8-8187-bc86-d2c69168799a`. Duplicate v1.30+v1.32 pages trashed 2026-05-18." } }
      ]
    }
  ],
  ...
  recent_activity: [
    { agent: "superclawman", at: "2026-06-08 nightly", note: "**Nightly docs audit (22:45 BRT) — structural refresh.** Structural triggers (4): fleet-wide OpenClaw 5.28→**6.1** (2e08f0f, 2026-06-08) across all 4 agents · SC launchagents 23→**24**: +`ai.openclaw.superclawman.script-review-fleet-hub` (script review fleet hub, 1200s interval) · Jr systemd_units 42→**46**: +`openclaw-jr-distill-compaction.service+timer` (Wave 4 DREAMING-ON-COMPACTION opportunistic memory consolidation) + `openclaw-jr-adherence.service+timer` (Wave 1 memory-ADHERENCE metric, OFFLINE drafter) · Ktulu pipeline_modules 16→**17**: +`ktulu_dream_on_compaction.py` (DREAMING-ON-COMPACTION memory consolidation module). Stats corrected: Sandman scripts 121→125; SC scripts 145→157; Jr shared_scripts 36→37. Notion mirror patched (header+footer+recent_activity+changelog). **Matrix v1.45→v1.46.**" },
    { agent: "superclawman", at: "2026-06-07 nightly", note: "**Nightly docs audit (22:45 BRT) — structural refresh.** Structural trigger: Ktulu plugins.allow 6→**7**: +`ktulu-a2a` (Ktulu A2A CEO↔seller plugin — `before_dispatch` handler for SC→Ktulu A2A chat, shadow+enforce modes, prospect sends stay gated by ktulu-sendguard, 2026-06-07). Cosmetic stats corrected: Sandman scripts 119→121; Superclawman scripts 142→145 (both noted in v1.44 recent_activity but stats objects not updated). Workspace canonicals committed: `workspace/AGENTS.md` (fleet delegation doctrine — bounded delegation via `fleet-step.sh sc`, `BOUNDED DELEGATION STEP` protocol + guardrails added 2026-06-07) + `memory/2026-06-07.md` (Skill 1 multimodal-ingest + Skill 2 learn-from-use auto-loop activity). Notion mirror patched (header+footer+recent_activity+changelog). **Matrix v1.44→v1.45.**" },
    { agent: "superclawman", at: "2026-06-06 nightly", note: "**Nightly docs audit (22:45 BRT) — structural refresh.** Structural trigger: Ktulu launchdaemons 36→**38** (30 active plists + 8 bak files): +`ai.openclaw.ktulu.a2a-learn` (daily 04:45, A2A learning daemon, 2026-06-06) + `ai.openclaw.ktulu.a2a-standup` (daily 09:00, A2A standup daemon, 2026-06-06). Cosmetic drift: Sandman scripts 119→121; Superclawman scripts 142→145. Workspace canonicals committed: `workspace/MEMORY.md` (WA delivery reporting hard rule — Fratiany false-positive fix 2026-06-06) + `memory/2026-06-04.md` + `memory/2026-06-06.md` + `memory/2026-06-07.md`. Notion mirror patched (header+footer+recent_activity+changelog). **Matrix v1.43→v1.44.**" },
    { agent: "superclawman", at: "2026-06-05 nightly", note: "**Nightly docs audit (22:45 BRT) — structural refresh.** Structural trigger: Ktulu launchdaemons 34→**36** (28 active plists + 8 bak files): +`ai.openclaw.ktulu.wa-probe-fix-verify` (wa-probe-fix-verify.sh, daily self-heal for WA probe fast-recheck recovery gate at 04:10 — fleet fix 2026-06-05); +`gateway.plist.bak-pre-pclock-20260605-124244` (gateway modified 2026-06-05, 8th bak). Cosmetic drift: Sandman scripts 115→119 doctrine 34→33; Superclawman scripts 143→142. Workspace canonicals committed: `KTULU_CANONICAL_v1.0.1.md` (network security note, ref FLEET_DEPLOY_SECURITY_CHECKLIST.md) + `memory/2026-06-05.md` (multimodal-ingest skill activity). Notion mirror patched (header+footer+recent_activity+changelog). **Matrix v1.42→v1.43.**" },
    { agent: "superclawman", at: "2026-06-05 evening", note: "**Docs-audit notification rerouted: C2 group → Pushover + Kratos Telegram + 14-day C2 soak.** Closes the last C2-only holdout in the fleet notification doctrine. **Architecture:** Audit now fan-outs to (A) Pushover ClaudeCode app → operator iPhone (primary), (B) Kratos (long-running Claude Code session in tmux `cc-telegram`, plugged into Telegram via the channels plugin) for reasoning + fix-execution, (C) C2 cards group for 14-day soak (hard drop **2026-06-19**). Kratos auto-verdicts every audit (ALL GREEN / N PENDING mechanical / N PENDING semantic / FAILED) and handles operator `fix` quote-replies under the same docs-only scope-lock binding the master docs session. Mechanical fixes auto-execute (handoff relocation, version-label sync, queue drain, Notion header/footer bump); semantic fixes (IA restructure, doctrine rewrite, naming decisions) write back with a proposal for operator confirmation. **Implementation details:** Pushover ClaudeCode app + token created via browser automation (firecrawl-interact + 1Password CLI service-account); token stored as `PUSHOVER_TOKEN_CLAUDECODE` in `~/.openclaw/secrets/pushover.env`. Kratos's behavioral spec lives at `~/.claude/projects/-Users-clawman--cc-telegram-kratos-workspace/memory/docs-audit-kratos-protocol.md` (indexed in `MEMORY.md` so it survives session restarts). **Key bug caught + fixed during validation:** initial design had the audit `curl bot${TOKEN}/sendMessage chat_id=8735701356` — but the bot allowlist `{allowFrom:[\"8735701356\"]}` filters out messages where the bot itself is sender, so the bot-sent message never reached Kratos's session input. Architecture corrected to use `tmux send-keys -t cc-telegram \"[DOCS-AUDIT-INBOUND]\\n<summary>\"` for direct stdin injection; Kratos reads it, applies protocol, replies via bot's reply-tool to chat 8735701356. Operator `fix` replies are unaffected (Paulo IS the sender, so they pass the allowlist normally). **End-to-end validated:** Pushover test push delivered (status 1); Kratos auto-verdict landed at message_id 75 (ALL GREEN, reasoned per the new memory). **Operator workflow now:** Pushover popup + Kratos verdict on Telegram every night at 22:45 BRT; quote-reply `fix` to handle pending items without opening the docs session. **Commits this session (~/.openclaw, local-only):** `9a6fa156` (A2A handoff relocation — resolved 2026-06-04 operator-review item from yesterday's audit), `6b7d2d9b` (initial Step 7 rewrite — Pushover + Telegram bot send + C2 soak), `5f553861` (architecture fix — tmux send-keys instead of bot-to-chat send). Memory: `project_docs_system_standard` unchanged (notification routing is implementation detail, not doctrine surface). **Matrix v1.41 → v1.42.**" },
