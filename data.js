...
window.INVENTORY = {
  generated_at: "2026-05-25T22:46:06-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.26",
  ...
  agents: [
    ...
    },
    {
      ...
      stats: { doctrine: 8, plugins: 5, launchdaemons: 20, pipeline_modules: 12, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      stats: { shared_scripts: 23, mcps: 4, skills: 3, systemd_units: 25, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
