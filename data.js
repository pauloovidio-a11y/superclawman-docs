...
window.INVENTORY = {
  generated_at: "2026-06-01T23:30:00-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.36",
  ...
  agents: [
    {
      ...
      status_phase: "Entry 96 stable · codex-sandman 3-layer pipeline live · OpenClaw 5.22→5.28 (e932160) 2026-06-01 · plugins.allow now explicit 68-item list (was *)",
    ...
    },
    {
      ...
      stats: { skills: 7, scripts: 132, subagents: 7, playbooks: 7, launchagents: 22, plugins: 10 }
    },
    {
      id: "ktulu",
      name: "Ktulu",
      ...
      stats: { doctrine: 8, plugins: 6, launchdaemons: 29, pipeline_modules: 16, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      stats: { shared_scripts: 35, mcps: 4, skills: 3, systemd_units: 42, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
...

    {
      ...
      rows: [
        ...
        { name: "plugins.allow IS RESTRICTED", status: { sandman: "no", superclawman: "yes", ktulu: "yes", jr: "yes" },
          notes: { default: "Hardened allowlist — only explicitly-listed plugins load.", sandman: "Explicit 68-plugin list (effective unrestricted — all major providers). Tightening is canonical TODO.", superclawman: "anthropic, browser, firecrawl, lossless-claw, perplexity, whatsapp, memory-core, openai, codex (2026-05-17 for codex script-review pipeline), bash-guard (+2026-06-01 — 10 total).", ktulu: "anthropic, whatsapp, memory-core, lossless-claw, browser, ktulu-sendguard — 6 plugins (browser added 2026-05-16; ktulu-sendguard 2026-05-25).", jr: "telegram, anthropic, lossless-claw, browser, perplexity, firecrawl + device-pair (6+1)." } }
      ]
    },
