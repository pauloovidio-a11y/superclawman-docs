...
window.INVENTORY = {
  generated_at: "2026-05-27T22:46:15-03:00",
  doc_title: "Sandman · Superclawman · Ktulu · Jr — Inventory Matrix",
  doc_status: "Canonical · v1.28",
  ...
  agents: [
    {
      ...
      stats: { skills: 29, scripts: 94, subagents: 3, hooks: 2, doctrine: 34 }
    },
    {
      id: "superclawman",
      name: "Superclawman",
      ...
      stats: { skills: 7, scripts: 117, subagents: 7, playbooks: 7, launchagents: 16, plugins: 9 }
    },
    {
      id: "ktulu",
      name: "Ktulu",
      ...
      stats: { doctrine: 8, plugins: 6, launchdaemons: 24, pipeline_modules: 15, playbooks: 2, skills: 1, subagents: 1 }
    },
    {
      id: "jr",
      ...
      stats: { shared_scripts: 29, mcps: 4, skills: 3, systemd_units: 33, tenants: 1, git_repo: "pauloovidio-a11y/openclaw-jr (private)" }
    }
  ],
